...
class actionAuthIndex extends cmsAction {
    ...
    public function run() {
        ...
        if ($is_submit) {
            ...
            if ($errors) {
                ...
                $logged_user = cmsUser::login($data['login_email'], $data['login_password'], $data['remember'] ?? false, false);
        ...
        return $this->cms_template->render('login', [
