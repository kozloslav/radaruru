...
define('LANG_MODERN_THEME_SWITCH', 'Переключить светлую/тёмную тему');
...
define('LANG_MODERN_LOGO_SVG_DARK', 'Логотип в SVG для тёмной темы');
define('LANG_MODERN_LOGO_SVG_DARK_HINT', 'Будет показан, когда включена тёмная тема оформления. Если не задан, используется логотип по умолчанию для тёмной темы. ');
...
define('LANG_MODERN_LOGO_SMALL_SVG_DARK', 'Маленький логотип в SVG для тёмной темы');
define('LANG_MODERN_LOGO_SMALL_SVG_DARK_HINT', 'Будет показан на малых разрешениях при включённой тёмной теме. ');
...
define('LANG_MODERN_HEAD_TOP', 'Готовый HTML, добавляемый перед всеми стилями и JavaScript файлами &lt;head&gt; страницы');
define('LANG_MODERN_FAVICON_HEAD', 'Готовый HTML, добавляемый в конец тега &lt;head&gt; страницы');
